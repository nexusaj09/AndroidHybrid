...
var Component = function (_App) {
	...
	_createClass(Component, [{
		...
		value: function lockerList(start) {
			...
			html += "\n\t\t\t<ul class=\"pagination center-align\">\n\t\t\t\t<li><a href=\"#!\" onclick=\"component.lockerList(0)\"><i class=\"material-icons\">chevron_left</i></a></li>\n\t\t\t";
			...
			for (var i = 0; i < items_total; i++) {
				...
				if (i % items_pergroup == 0) {
					...
					html += "\n\t\t\t\t\t<li class=" + active + "\" onclick=\"component.lockerList(" + page_start + ")\">\n\t\t\t\t\t\t<a href=\"#!\">" + page++ + "</a>\n\t\t\t\t\t</li>\n\t\t\t\t";
				}
			}
			html += "\n\t\t\t\t<li><a href=\"#!\" onclick=\"component.lockerList(" + page_start + ")\"><i class=\"material-icons\">chevron_right</i></a></li>\n\t\t\t</ul>\n\t\t";
