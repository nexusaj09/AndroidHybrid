...
class App{
	constructor(){
		this.users = [
			{
				"id":1,
				"photo":"img/admin1.jpg",
				"usn":"15000374400",
				"password":"15000374400",
				"firstname":"Bryan ",
				"lastname":"Bayer"
	...
	homePage(){
		let html =`
			...
			<br>
		  	...
		  	<center><img class="app_logo" src="img/amalogo.png" /></center>
			<h3 class="app_name">Scoreboard App</h3>
			<h6 class="app_desc">Dev Bryan James Bayer</h6>
			<br>
			<div class="center-align">
				<img class="app_logo" src="img/scoreboard.jpg" />
			</div>
			<br>
			<br>
 <center><a class="btn-floating btn-large waves-effect waves-light red accent-4" onclick="component.loginPage()">ADMIN</a></center>
<br>

  <center><a class="btn-floating btn-large waves-effect waves-light blue"onclick="component.preloaderForSpectator()">SPECTATOR</a></center>
  <br>
  <br>
  <br>
	...
	loginPage(){
		let html = `
			  	<center><img class="app_logo" src="img/amalogo.png" /></center>
			<h3 class="app_name">LOG IN</h3>
			<h6 class="app_desc">Administrator Login here</h6>
			<div class="center-align">
				<img class="app_logo" src="img/login.png" />
			</div>
			<div class="login_input">
				<div class="row">				
					<div class="col s12 center-align">
					  <label class="active" for="first_name2"><b>Universal Student Number</b></label>
						<input id="txtUSN" style="background-color:white;color:black;width:80%;padding-left:15px;padding-right:15px;font-size:18px;text-align:center;" maxlength="11" type="text" placeholder="ENTER USN" />
					</div>
					<div class="col s12 center-align">
									  <label class="active" for="first_name2"><b>Password</b></label>
						<input id="txtPASS" style="background-color:white;color:black;width:80%;padding-left:15px;padding-right:15px;font-size:18px;text-align:center;" maxlength="20" type="password" placeholder="ENTER PASSWORD" />
					</div>

					<div class="col s12 center-align">
					<button onclick="component.homePage()" style="background-color: #382d2d;"class="waves-effect waves-light btn" >Back</button>
						<button onclick="component.verifyLogin()" style="background-color: #c84445;"class="waves-effect waves-light btn" >Verify</button>
					</div>
				</div>				
			</div>
		`;
		html+=`<div id ="sideNav"></div><div id="spectatorPage"></div><div id="adminDashboard"></div>`;
	...
	verifyLogin(){
		...
		let msg = "Invalid USN or Password, Try again!";
		let errFlag = true;
		let student = {};
		for(let i=0;i<this.users.length;i++){
			if(txtUSN==this.users[i].usn){
				if(txtPASS==this.users[i].password){
					...
					errFlag = true;
					msg = "Invalid USN or Password, Try again!";
		...
		if(errFlag){
			...
			this.preloader();
			setTimeout(function(){
				component.adminDashboard(student);
			},3000);
		}		
	}
...
<nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo">Scoreboard App</a>
    ...
    <li><div class="userView">
      ...
      <a href="#!user"><img src="${student.photo}"></a>
      <h5 style="color:black;"><b>Admin: </b> ${student.firstname} ${student.lastname}</h5>
      <div class="divider">
    
    </div></li>
    <li><a href="#"onclick="component.homePage()"><i class="medium material-icons">store</i>Home</a></li>
        <li><a href="#!"><i class="medium material-icons">assignment</i>Scoreboard</a></li>
           <li><a href="#!"><i class="medium material-icons">view_list</i>Standings</a></li>
    <li><div class="divider"></div></li>
    <li><a class="subheader">Administrator Online</a></li>
    				<center><h5 style="color: black;">${student.firstname}</h5></center>
    				    <li><a class="subheader">List of Admins</a></li>
    				    `;
    				    for(let i =0;i<this.users.length;i++){
    				    html+=`
    				<center><h5 style="color: black;">${this.users[i].firstname} ${this.users[i].lastname}</h5></center>
    				`;
    				}
    				html+=`
    				<br>
            <li><a href="#"onclick="component.loginPage()"><i class="medium material-icons">input</i>Logout as Administrator</a></li>
  </ul>
...
`;
	html+=`
	<div class="center-align">
	 <img src="img/score.jpeg">
	 </div>
    <ul class="collection">
    <li style="background-color: cyan;"class="collection-item avatar">
      <img src="img/basketball.png" alt="" class="circle">
      <span class="title"style="color: black;"><b>Basketball</b></span>
      <p style="color: black;">Initiate Scoreboard<br>
         Basketball Standings
      </p>
     <a href="#!" class="secondary-content"><i class="material-icons">&nbspqueue</i><p style="color: black;"><b>Initiate</b></p></a>

    </li>
    <li style="background-color: lime;"class="collection-item avatar">
 <img src="img/vollleyball.png" alt="" class="circle">
      <span class="title"style="color: black;"><b>Volleyball</b></span>
      <p style="color: black;">Initiate Scoreboard<br>
         Volletball Standings
      </p>
     <a href="#!" class="secondary-content"><i class="material-icons">&nbspqueue</i><p style="color: black;"><b>Initiate</b></p></a>
    </li>
    <li style="background-color: yellow;"class="collection-item avatar">
 <img src="img/badminton.png" alt="" class="circle">
      <span class="title"style="color: black;"><b>Badminton</b></span>
      <p style="color: black;">Initiate Scoreboard<br>
         Badminton Standings
      </p>
     <a href="#!" class="secondary-content"><i class="material-icons">&nbspqueue</i><p style="color: black;"><b>Initiate</b></p></a>
    </li>
    <li style="background-color: pink;"class="collection-item avatar">
 <img src="img/tabletennis.jpg" alt="" class="circle">
      <span class="title"style="color: black;"><b>Table Tennis</b></span>
      <p style="color: black;">Initiate Scoreboard<br>
  ...
  <footer class="page-footer">
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                <h5 class="white-text">Scoreboard App.</h5>
                <p class="grey-text text-lighten-4">Scoreboard App 2017, Ameer Peralta and Bryan Bayer</p>
              </div>
          </div>
          <div class="footer-copyright">
            <div class="container">
            © 2017 Copyright
            <a class="grey-text text-lighten-4 right" href="#!">Scoreboard App</a>
            </div>
          </div>
        </footer>
	...
	preloader(){
		let html= `
			...
			<br>
			<br>
			<h5>Verifying USN and Password. . . .</h5>
			</center>
		`;
		this.reRender(html,$('#app')[0]);
	}
	preloaderForSpectator(){
		let html= `
			<center style="margin-top:50%;">
			<img src="img/loading.gif">
			<br>
...
<nav class="light-blue lighten-1" role="navigation">
    ...
    <li><div class="userView">
      ...
      <a href="#!user"><img src="img/sportslogo.png"></a>
      <div class="divider">
    ...
    <li><a href="#"onclick="component.homePage()"><i class="medium material-icons">store</i>Home</a></li>
        <li><a href="#!"><i class="medium material-icons">assignment</i>Scoreboard</a></li>
           <li><a href="#!"><i class="medium material-icons">view_list</i>Standings</a></li>
    <li><div class="divider"></div></li>
    <li><a class="subheader">Spectator</a></li>
            <li><a href="#"onclick="component.loginPage()"><i class="medium material-icons">input</i>Logout as Spectator</a></li>
  </ul>
  <a href="#" data-activates="slide-out" class="button-collapse"><i class="material-icons">menu</i></a>
  </div>
  </nav>
  <div class="center-align">
  <img src="img/rsz_1sports.png">
  </div>
    <ul class="collection">
    <li style="background-color: cyan;"class="collection-item avatar">
      <img src="img/basketball.png" alt="" class="circle">
      <span class="title"style="color: black;"><b>Basketball</b></span>
      <p style="color: black;">Watch as Spectator<br>
         Basketball Standings
      </p>
     <a href="#!" class="secondary-content"><i class="material-icons">&nbspvideocam</i><p style="color: black;"><b>Watch</b></p></a>
